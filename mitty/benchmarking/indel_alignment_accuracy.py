...
@click.option('--sample-name', help='Name of sample. Leave out to test against whole graph')
@click.option('--indel-range', help='Maximum base pair count of indels we process_bams', type=int, default=50)
